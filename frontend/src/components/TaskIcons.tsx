...
export const TaskIcon: React.FC<TaskIconProps> = ({ taskId, className = 'w-9 h-9', size }) => {
  ...
  switch (taskId) {
    ...
    case 'dual_rebate_monitor':
      return (
        <svg viewBox="0 0 48 48" aria-hidden="true" className={className} style={style}>
          <rect x="8" y="8" width="32" height="32" rx="8" fill="#d97706" />
          <rect x="12" y="14" width="16" height="20" rx="3" fill="#f59e0b" />
          <rect x="20" y="14" width="16" height="20" rx="3" fill="#fbbf24" opacity="0.9" />
          <path d="M16 24h8M16 28h6" stroke="#fff" strokeWidth="2" strokeLinecap="round" />
          <path d="M24 20h8M24 24h8M24 28h5" stroke="#92400e" strokeWidth="2" strokeLinecap="round" />
          <circle cx="33" cy="19" r="2" fill="#ef4444" />
        </svg>
      );
    default:
      return (
